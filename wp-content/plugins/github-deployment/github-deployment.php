    ...
    public function page() {
        ...
        if ( ! empty( $_POST['github_deployment_action'] ) ) {
            ...
            if ( 'save' === $action ) {
                ...
                $status = $this->status( true );
                $review = $this->review();
                $backup_required = 'no' !== sanitize_key( wp_unslash( $_POST['deployment_backup'] ?? 'yes' ) );
